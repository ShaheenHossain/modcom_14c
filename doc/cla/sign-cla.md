...
`cla-submission` `at` `modcom.ca`.  In that case someone from the Odoo team will
make the pull request on your behalf.

* Printable Odoo CCLA v1.0 https://www.modcom.ca/files/legal/Odoo-CCLA-v1.0.pdf
* Printable Odoo ICLA v1.0 https://www.modcom.ca/files/legal/Odoo-ICLA-v1.0.pdf
...
irrevocable license to the project maintainer, ModCom to use, modify and
