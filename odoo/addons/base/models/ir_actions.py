...
class IrActionsServer(models.Model):
    ...
    Since  ModCom 8.0 a button 'Create Menu Action' button is available on the
...
#  - env:  ModCom Environment on which the action is triggered
#  - model:  ModCom Model of the record on which the action is triggered; is a void recordset
#  - record: record on which the action is triggered; may be void
#  - records: recordset of all records on which the action is triggered in multi-mode; may be void
#  - time, datetime, dateutil, timezone: useful Python libraries
#  - float_compare:  ModCom function to compare floats based on specific precisions
