...
class Alias(models.Model):
    """A Mail Alias is a mapping of an email address with a given of ModCom Document
       model. It is used by of ModCom's mail gateway when processing incoming emails
    ...
    def name_get(self):
        """Return the mail alias display alias_name, including the implicit
           ...
           e.g. `jobs@mail.modcom.ca` or `jobs` or 'New Alias'
        """
        res = []
        for record in self:
