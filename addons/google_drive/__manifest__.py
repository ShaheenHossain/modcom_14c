...

{
    ...
    'description': """
Integrate google document to ModCom record.
============================================

This module allows you to integrate google documents to any of your ModCom record quickly and easily using OAuth 2.0 for Installed Applications,
